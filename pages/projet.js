  ...
  <Layout title="Le projet">
    ...
    <div>
        <p>
          ...
          Ce site web est édité par l'association OpenAcadémie,
          boîte n°3, 8 bis avenue Anatole France 94600 Choisy-le-Roi ;
          directeur de la publication : Étienne ANDRÉ

          <br />
          <br />

          Ce site web est hébergé par github.com
        </p>
        <style jsx>{`
          p {
            max-width: 565px;
